...
#define TC_PROFILE 0
	...
	#define TC_PROFILE_BEGIN_SESSION(name, filepath) ::TerraformCrater::Instrumentor::Get().BeginSession(name, filepath)
	#define TC_PROFILE_END_SESSION() ::TerraformCrater::Instrumentor::Get().EndSession()
	#define TC_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::TerraformCrater::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::TerraformCrater::InstrumentationTimer timer##line(fixedName##line.Data)
